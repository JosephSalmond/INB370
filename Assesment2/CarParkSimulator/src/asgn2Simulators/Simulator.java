...
/**
 * Class to hold parameters and to provide random trial services for the
 * simulation. Simulation relies by default on parameters set in the file
 * Constants.java. User has the option to set these parameters using the
 * multi-argument constructor. Methods provide intended stay durations according
 * to N(meanStay,sdStay^2), and Bernoulli trial outcomes for vehicle creation.
 * 
 * @author hogan
 * 
 */
public class Simulator {
     ...
     *             if one or more probabilities are invalid, or if meanStay < 0
     *             or sdStay < 0
     */
    public Simulator() throws SimulationException {
	this(Constants.DEFAULT_SEED, Constants.DEFAULT_INTENDED_STAY_MEAN,
		Constants.DEFAULT_INTENDED_STAY_SD, Constants.DEFAULT_CAR_PROB,
     ...
     * @param meanStay
     *            double holding the mean of the Normal Distribution of intended
     *            parking stays
     * @param sdStay
     *            double holding the standard deviation of the stay distribution
     * @param carProb
     *            double holding the probability that a car will arrive in the
     *            current minute
     * @param smallCarProb
     *            double holding the probability that the car that has arrived
     *            is a small car
     * @param mcProb
     *            double holding the probability that a motorcycle will arrive
     *            in the current minute
     * @throws SimulationException
     *             if one or more probabilities are invalid, or if meanStay < 0
     *             or sdStay < 0
     */
    public Simulator(int seed, double meanStay, double sdStay, double carProb,
	    double smallCarProb, double mcProb) throws SimulationException {
    ...
    /**
     * Coin toss to see whether motorCycle is created. Uses recorded mc
     * probability
     * 
    ...
    /**
     * Coin toss to see whether car is created. Uses recorded car existence
     * probability
     * 
     * @return true if trial is successful, false otherwise
     */
     ...
     * 
     * @return random duration drawn from N(meanStay,meanStay/3) or
     *         MINIMUM_STAY, whichever is greater
     */
    ...
    /**
     * Coin toss to see whether car is to be small car Uses recorded small car
     * probability
     * 
     * @return true if trial is successful, false otherwise
     */
     ...
     *            in the current minute
     * @throws SimulationException
     *             if one or more probabilities are invalid
     */
    ...
    /**
     * Utility method to implement a <a
     * href="http://en.wikipedia.org/wiki/Bernoulli_trial">Bernoulli Trial</a>,
     * a coin toss with two outcomes: success (probability successProb) and
     * failure (probability 1-successProb)
     * 
     * @param successProb
