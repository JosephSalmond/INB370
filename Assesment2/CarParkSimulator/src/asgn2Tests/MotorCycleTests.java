...
public class MotorCycleTests {
	...
	testMotorCycle
		.enterParkedState(testValueNegative, testIntendedDuration);
    }

    @Test(timeout = 1000, expected = VehicleException.class)
    public void testEnterParkedStateIntendedDurationLessThanMin()
	    throws VehicleException {
	testMotorCycle = new MotorCycle(testConstructorVehID,
		testConstructorArrivalTime);
	testMotorCycle.enterParkedState(testParkingTime,
		(Constants.MINIMUM_STAY - 1));
    }
    ...
    @Test(timeout = 1000, expected = VehicleException.class)
    public void testExitParkedStateDepartureLessThanParkingTime()
	    throws VehicleException {
	testMotorCycle = new MotorCycle(testConstructorVehID,
		testConstructorArrivalTime);
	testMotorCycle.enterParkedState(testParkingTime, testIntendedDuration);
	testMotorCycle.exitParkedState(testParkingTime - 1);
	assertTrue(testMotorCycle.getDepartureTime() < testMotorCycle
		.getParkingTime());
    }

    public void testExitParkedStateDurationGreaterThanParkingTime()
	    throws VehicleException {
	testMotorCycle = new MotorCycle(testConstructorVehID,
		testConstructorArrivalTime);
	testMotorCycle.enterParkedState(testParkingTime, testIntendedDuration);
	testMotorCycle.exitParkedState(testParkingTime + testIntendedDuration);
	assertFalse(testMotorCycle.getDepartureTime() < testMotorCycle
		.getParkingTime());
    }
    ...
    @Test(timeout = 1000, expected = VehicleException.class)
    public void testExitQueuedStateExitNotLaterThanArrivalTime()
	    throws VehicleException {
	testMotorCycle = new MotorCycle(testConstructorVehID,
		testConstructorArrivalTime);
	testMotorCycle.enterQueuedState();
	...
	testMotorCycle = new MotorCycle(testConstructorVehID,
		testConstructorArrivalTime);
	assertEquals(testConstructorArrivalTime,
		testMotorCycle.getArrivalTime());
    }
	...
	testMotorCycle = new MotorCycle(testConstructorVehID,
		testConstructorArrivalTime);
	testMotorCycle.enterParkedState(testParkingTime, testIntendedDuration);
	assertEquals((testParkingTime + testIntendedDuration),
		testMotorCycle.getDepartureTime());
    }
    ...
    // this tests that was parked method returns true if vehicle is currently
    // parked
    @Test(timeout = 1000)
