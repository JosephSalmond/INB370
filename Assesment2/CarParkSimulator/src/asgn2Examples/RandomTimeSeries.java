...
/**
 * Example code based on the Stack Overflow example and the standard JFreeChart
 * demos showing the construction of a time series data set. Some of the data
 * creation code is clearly a quick hack and should not be taken as indicative
 * of the required coding style.
 * 
